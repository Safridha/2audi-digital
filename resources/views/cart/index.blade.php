...
<div class="container mt-5 mb-5">
    ...
    @else
        ...
        {{-- FORM UNTUK KIRIM ITEM YANG DICENTANG KE HALAMAN CHECKOUT --}}
                ...
                <table class="table table-bordered align-middle bg-white">
                    ...
                    @foreach($items as $item)
                        ...
                        <tr>
                            ...
                            {{-- Total Finishing (tanpa kolom finishing) --}}
                            <td class="text-end">
                            ...
                            <td class="text-center align-middle">
                                <div class="d-flex flex-column gap-2" style="min-width: 90px;">
                                    ...
                                    <form action="{{ route('cart.remove', ['item' => $item->id]) }}"
                                          method="POST"
                                          class="w-100"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // event change tiap checkbox (pakai event delegation)
